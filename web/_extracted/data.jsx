// data.jsx — Demo catalog data for Bortier tenant
// All SKUs are invented for this mockup.
...
// Placeholder tone swatches used to render "photo stand-ins" consistently.
const TONE = {
...
const PRODUCTS = [
  {
    ...
    colors: [
      { id: "sand", name: "Areia", tone: "sand" },
      { id: "noir", name: "Preto", tone: "noir" },
      { id: "coral", name: "Coral", tone: "coral" },
    ],
    sizes: ["PP", "P", "M", "G", "GG"],
    ...
    madeIn: "São Paulo, BR",
    moq: 6,
    stockBySize: { PP: 42, P: 120, M: 160, G: 80, GG: 24 },
    featured: true,
  },
  {
    ...
    colors: [
      { id: "clay", name: "Argila", tone: "clay" },
      { id: "olive", name: "Oliva", tone: "olive" },
      { id: "bone", name: "Osso", tone: "bone" },
    ],
    sizes: ["PP", "P", "M", "G", "GG"],
    ...
    fabric: "80% Poliamida / 20% Elastano",
    madeIn: "São Paulo, BR",
    moq: 6,
  },
  {
    ...
    colors: [
      { id: "ochre", name: "Ocre", tone: "ochre" },
      { id: "shell", name: "Concha", tone: "shell" },
    ],
    sizes: ["P", "M", "G"],
    tags: ["Top faixa", "Brasileirinha"],
    moq: 6,
  },
  {
    ...
    colors: [
      { id: "noir", name: "Preto", tone: "noir" },
      { id: "terra", name: "Terra", tone: "terra" },
    ],
    sizes: ["P", "M", "G", "GG"],
    tags: ["Decote profundo", "Cavada alta"],
    moq: 4,
  },
  {
    ...
    colors: [
      { id: "noir", name: "Preto", tone: "noir" },
      { id: "olive", name: "Oliva", tone: "olive" },
      { id: "cream", name: "Creme", tone: "cream" },
    ],
    sizes: ["PP", "P", "M", "G", "GG"],
    tags: ["Alto impacto", "Alças cruzadas"],
    moq: 6,
  },
  {
    ...
    sizes: ["PP", "P", "M", "G", "GG"],
    tags: ["Cintura alta", "Tecido compressivo"],
    moq: 6,
    featured: true,
  },
  {
  ...
  },
  {
    ...
    colors: [
      { id: "cream", name: "Natural", tone: "cream" },
    ],
    sizes: ["Único"],
    moq: 6,
  },
...
Object.assign(window, { TENANT, COLLECTIONS, CATEGORIES, PRODUCTS, TIERS, LOOKBOOK, TONE });

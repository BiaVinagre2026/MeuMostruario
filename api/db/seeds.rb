...
# ---------------------------------------------------------------------------
# 4. Catalog demos per tenant
# ---------------------------------------------------------------------------
require_relative "seeds/photo_catalog_demo"

seeded_catalog_links = SeedPhotoCatalogDemo.run!
...
puts ""
puts ""
puts " CATALOG DEMO LINKS"
puts " ─────────────────" 
seeded_catalog_links.each do |entry|
  puts "   #{entry[:tenant_slug]}"
  puts "     Publico:  #{entry[:public_url]}"
  puts "     Atacado:  #{entry[:wholesale_url]}"
end
puts ""
